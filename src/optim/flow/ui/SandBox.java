...
public class SandBox {
	public static void main(String[] args) {
		...
		double[][] capacityMatrix = { { 10, 12, 9, 0, 0 }, { 0, 0, 6, 0, 0 }, { 0, 0, 0, 15, 0 }, { 0, 0, 0, 0, 9 },
				{ 0, 0, 0, 0, 0 } };
		double[][] costMatrix = { { -1, 0, 1, -10, 10 }, { 10, 10, -25, -10, -10 }, { 0, 0, 0, 5, 0 },
				{ -10, -10, -1, 1, 3 }, { 0, 0, 0, 0, 0 } };
		double[] verticesDemand = { -10, -5, 0, 7, 8 };

		double[][] optimal = { { 10, 1, 9, 0, 0 }, { 0, 0, 6, 0, 0 }, { 0, 0, 0, 15, 0 }, { 0, 0, 0, 0, 8 },
				{ 0, 0, 0, 0, 0 } };
